...
def parse_args():
  ...
  parse.add_argument('--dataroot', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/data/LIDC-HDF5-256', dest='dataroot',
  ...
  parse.add_argument('--valid_dataset', type=str, default='test', dest='valid_dataset',
                     help='Train or test or valid')
  parse.add_argument('--datasetfile', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/data/train.txt', dest='datasetfile',
                     help='Train or test or valid file path')
  parse.add_argument('--valid_datasetfile', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/data/test.txt', dest='valid_datasetfile',
                     help='Train or test or valid file path')
  parse.add_argument('--ymlpath', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/experiment/multiview2500/d2_multiview2500.yml', dest='ymlpath',
...
if __name__ == '__main__':
  args = parse_args()
  # wandb.init(project='3DGAN', name='3DGAN'
  #注释Ctrl+K+C
  #取消注释Ctrl+K+U
  # wandb.init(project='X2CT_GAN', name='checkpoints10',
  #            config={
  ...
  # merge config messages with yaml
