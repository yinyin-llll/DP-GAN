...
def parse_args():
  ...
  parse.add_argument('--datasetfile', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/data/test.txt', dest='datasetfile',
  ...
  parse.add_argument('--resultdir', type=str, default='D:/Anaconda/jupyter notebook/X2CT-GAN/X2CT/3DGAN/multiview', dest='resultdir',
