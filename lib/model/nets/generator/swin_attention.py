...
# img_size=128 patch_size=4 in_chans=64 embed_dim=64 norm_layer=nn.LayerNorm
...
class RSTB(nn.Module):
    ...
    def __init__(self, dim=64, input_resolution=(32,32), depth=6, num_heads=8, window_size=8,
                 mlp_ratio=4., qkv_bias=True, qk_scale=None, drop=0., attn_drop=0.,
                 drop_path=0., norm_layer=nn.LayerNorm, downsample=None, use_checkpoint=False,
...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=128, patch_size=4, in_chans=3,
                 embed_dim=64, depths=[6, 6, 6, 6], num_heads=[8, 8, 8, 8],
        ...
        # img_size=128 patch_size=1 in_chans=96 embed_dim=96 norm_layer=nn.LayerNorm
        self.patch_embed = PatchEmbed(
